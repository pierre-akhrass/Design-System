...
const SampleListItems = ({ animated = false }: { animated?: boolean }) =>
  animated ? (
    <>
...
export const Light: Story = {
  name: 'Playground/Light', args: { theme: 'light' } }
export const Dark: Story = {
  name: 'Playground/Dark', args: { theme: 'dark' } }
export const Bordered: Story = {
  name: 'Playground/Bordered', args: { theme: 'light', bordered: true } }

export const DocumentItem: Story = {
  name: 'Playground/Document Item',
  render: (args) => (
    <List {...args}>
      <ListItem variant="document" label="Document name" meta="270 Kbs" />
  ...
  render: (args) => (
    <List {...args}>
      ...
      <ListItem
        variant="card"
        label="Another item"
        description="With supporting text"
      />
    </List>
  ),
}
