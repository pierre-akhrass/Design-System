...
export const WithoutCard: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Same panel without the promotional card slot — columns expand to fill the full width.',
      },
    },
  },
  args: {
...
export const DarkMode: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Dark surface — useful when embedded inside a dark navbar dropdown.',
      },
    },
  },
  args: {
