    ...
    docs: {
      description: {
        component: [
          ...
          '| `$color-system-gray-900` | `#292929` | Heading, author name, active pagination |',
          '| `$color-system-gray-700` | `#545454` | Label, quote text |',
          '| `$color-system-gray-600` | — | Inactive pagination, author role |',
          '| `$color-system-gray-200` | — | Pagination line (inactive) |',
          '| `$color-system-gray-700` | — | Quote icon |',
          '| `$color-system-gray-600` | — | Image placeholder icon |',
