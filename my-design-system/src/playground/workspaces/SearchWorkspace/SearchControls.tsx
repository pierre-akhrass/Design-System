...
export const SearchControls = ({ config, onChange }: SearchControlsProps) => {
  ...
  return (
    <div className="search-controls">
      ...
      <ControlRow label="placeholder">
        <input className="ctrl-input ctrl-input--full" type="text" value={config.placeholder} onChange={(e) => set('placeholder', e.target.value)} placeholder="Placeholder text" spellCheck={false} />
      </ControlRow>
      ...
      <ControlRow label="theme">
        <Segmented options={['light', 'dark']} value={config.theme} onChange={(v) => set('theme', v as SearchConfig['theme'])} />
      </ControlRow>

      <ControlRow label="size">
        <Segmented options={['default', 'compact']} value={config.size} onChange={(v) => set('size', v as SearchConfig['size'])} />
      </ControlRow>

      <ControlRow label="showClear">
        <Toggle value={config.showClear} onChange={(v) => set('showClear', v)} label="Toggle show clear" />
      </ControlRow>
      ...
      <ControlRow label="className">
        <input className="ctrl-input ctrl-input--full" type="text" value={config.customClass} onChange={(e) => set('customClass', e.target.value)} placeholder="e.g. my-search" spellCheck={false} />
      </ControlRow>

      <ControlRow label="id">
        <input className="ctrl-input ctrl-input--full" type="text" value={config.customId} onChange={(e) => set('customId', e.target.value)} placeholder="e.g. hero-search" spellCheck={false} />
      </ControlRow>

      <div className="ctrl-css-wrap">
        <textarea className="ctrl-css-textarea" value={config.customCss} onChange={(e) => set('customCss', e.target.value)} placeholder={`.my-search { ... }`} spellCheck={false} rows={5} />
      </div>
    </div>
  )
}
