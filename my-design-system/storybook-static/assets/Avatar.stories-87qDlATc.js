...
Pass \`theme="dark"\` to any of the three components for the dark-mode palette. They also respond automatically to \`prefers-color-scheme: dark\` when no theme prop is set.
    ...
    return <div style={{
      ...
      alignItems: 'flex-start'
        ...
        <div>
          ...
          <AvatarBlock avatar={<Avatar type="image" size="medium" src={IMG[0]} alt={blockTitle} theme={args.theme} />} title={blockTitle} description={blockDesc} theme={args.theme} />
        </div>
    ...
    return <div style={{
      ...
      transition: 'background 0.2s ease'
        ...
        gap: 80
          ...
          <div>
            ...
            gridTemplateColumns: '60px repeat(5, 52px)'
              ...
              alignItems: 'center'
                    ...
                    <Avatar type={type} size={size} initials="A" src={IMG[0]} alt="User" icon={<PersonIcon />} theme={theme} />
                  </div>)])}
            </div>
          </div>
          ...
          <div>
            <span style={sectionLabel}>Avatar Block</span>
            <AvatarBlock avatar={<Avatar type="image" size="medium" src={IMG[0]} alt="Jane Doe" theme={theme} />} title="Jane Doe" description="Product Designer" theme={theme} />
          </div>
  ...
  render: () => <div style={{
    ...
    gap: 24
      ...
      {(['overlap', 'spaced'] as const).map(spacing => <div key={spacing} style={docRow}>
          <span style={{
        ...docLabel,
        minWidth: 60
      }}>{spacing}</span>
      ...
      return <div key={theme} style={{
        ...
        flex: 1
          ...
          gap: 12
            ...
            <AvatarBlock avatar={<Avatar type="image" size="medium" src={IMG[0]} alt="Jane" theme={theme} />} title="Jane Doe" description="Product Designer" theme={theme} />
          </div>;
    })}
    </div>
