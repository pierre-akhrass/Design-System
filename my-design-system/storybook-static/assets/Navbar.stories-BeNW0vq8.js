...
| { kind: 'custom'; node: ReactNode }`,elements:[{name:`signature`,type:`object`,raw:`{\r
  ...
  render: ({
    ...
    return <Navbar colorMode={colorMode} logo={logoSrc || undefined} actions={resolvedActions}>\r
        {links.map((entry, i) => {
