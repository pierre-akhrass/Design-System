      ...
      return <div key={theme} style={{
        ...
        padding: '32px 40px 42px' // extra bottom for arrow
          ...
          paddingBottom: 10
              ...
              {placements.map(p => <Tooltip key={p} title="Title" body="Body text" placement={p} theme={theme} />)}
            </div>
          </div>;
    })}
    </div>
